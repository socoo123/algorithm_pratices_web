...
graph TD
    ...
    classDef leaf fill:#161722,stroke:#8be9fd,color:#f8f8f2
    class n0 start
...
graph TD
    ...
    classDef lv0 fill:#2b2d3a,stroke:#f1fa8c,color:#f8f8f2
    classDef lv fill:#2b2d3a,stroke:#8be9fd,color:#f8f8f2
    classDef dots fill:#161722,stroke:#8be9fd,color:#f8f8f2
    class r lv0
...
flowchart TD
    ...
    classDef tool fill:#2b2d3a,stroke:#8be9fd,color:#f8f8f2
    classDef done fill:#2b2d3a,stroke:#50fa7b,color:#f8f8f2
    class A start
    class B,C proc
    class D,E,F tool
