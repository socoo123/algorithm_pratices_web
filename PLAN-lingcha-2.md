...
> 最后更新：批 6 完成（磁盘 120 篇 / 120/300）

## 〇、当前指针（清空会话后只看这里）

| 项 | 值 |
|----|-----|
| **下一批** | **批 7** · 网格收尾 + 图论①：BFS/0-1 BFS + DFS/Dijkstra/MST |
| 已完成 | 6/15 批（120/300） |
| 磁盘核对 | `ls solutions/lingcha-2/*.md \| wc -l` 应为 `120`；`120 ÷ 20 = 6` 已完成批 → 下一批 = 7 |
| 预查新题 | #3286, #3552, #3243 |
| 样例 md | `solutions/lingcha-2/01-matrix.md`（多源 BFS）或 `pacific-atlantic-water-flow.md`（边界反向 DFS） |
