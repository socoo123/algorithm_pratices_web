...
> 最后更新：批 8 完成（磁盘 160 篇 / 160/300）

## 〇、当前指针（清空会话后只看这里）

| 项 | 值 |
|----|-----|
| **下一批** | **批 9** · 图论收尾 + 单调栈 + 贪心开头 |
| 已完成 | 8/15 批（160/300） |
| 磁盘核对 | `ls solutions/lingcha-2/*.md \| wc -l` 应为 `160`；`160 ÷ 20 = 8` 已完成批 → 下一批 = 9 |
| 预查新题 | #3216 |
| 样例 md | `solutions/lingcha-2/open-the-lock.md`（图论建模 BFS）或 `is-graph-bipartite.md`（二分图染色） |
