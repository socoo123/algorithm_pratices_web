...
> 最后更新：批 5 完成（磁盘 100 篇 / 100/300）

## 〇、当前指针（清空会话后只看这里）

| 项 | 值 |
|----|-----|
| **下一批** | **批 6** · 链表树② + 网格开头：删点/回溯 + 网格 DFS |
| 已完成 | 5/15 批（100/300） |
| 磁盘核对 | `ls solutions/lingcha-2/*.md \| wc -l` 应为 `100`；`100 ÷ 20 = 5` 已完成批 → 下一批 = 6 |
| 预查新题 | — |
| 样例 md | `solutions/lingcha-2/binary-tree-pruning.md`（自底向上删点）或 `count-good-nodes-in-binary-tree.md`（自顶向下 DFS） |
