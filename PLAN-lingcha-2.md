...
> 最后更新：批 12 完成（磁盘 240 篇 / 240/300）

## 〇、当前指针（清空会话后只看这里）

| 项 | 值 |
|----|-----|
| **下一批** | **批 13** · 字符串收尾 + DP①：Z 函数/后缀 + 前后缀分解 |
| 已完成 | 12/15 批（240/300） |
| 磁盘核对 | `ls solutions/lingcha-2/*.md \| wc -l` 应为 `240`；`240 ÷ 20 = 12` 已完成批 → 下一批 = 13 |
| 预查新题 | #3388, #3403, #3722, #3147, #3259 |
| 样例 md | `solutions/lingcha-2/find-the-index-of-the-first-occurrence-in-a-string.md`（KMP）或 `maximum-length-of-repeated-subarray.md`（哈希）；前后缀分解尚无同族样例，可继续用字符串篇看结构 |
