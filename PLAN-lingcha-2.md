...
> 最后更新：批 9 完成（磁盘 180 篇 / 180/300）

## 〇、当前指针（清空会话后只看这里）

| 项 | 值 |
|----|-----|
| **下一批** | **批 10** · 贪心①：最值贪心 / 区间 / 配对 / 脑筋急转弯 |
| 已完成 | 9/15 批（180/300） |
| 磁盘核对 | `ls solutions/lingcha-2/*.md \| wc -l` 应为 `180`；`180 ÷ 20 = 9` 已完成批 → 下一批 = 10 |
| 预查新题 | #3191, #3075 |
| 样例 md | `solutions/lingcha-2/split-a-string-in-balanced-strings.md`（划分型贪心）或 `lexicographically-smallest-string-after-a-swap.md`（字典序） |
