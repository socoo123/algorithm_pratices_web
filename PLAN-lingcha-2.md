...
> 最后更新：批 7 完成（磁盘 140 篇 / 140/300）

## 〇、当前指针（清空会话后只看这里）

| 项 | 值 |
|----|-----|
| **下一批** | **批 8** · 图论②：建模 BFS / 拓扑 / Dijkstra / 二分图 |
| 已完成 | 7/15 批（140/300） |
| 磁盘核对 | `ls solutions/lingcha-2/*.md \| wc -l` 应为 `140`；`140 ÷ 20 = 7` 已完成批 → 下一批 = 8 |
| 预查新题 | #3015, #3310, #3341, #3112, #3387（建议顺带 #2998） |
| 样例 md | `solutions/lingcha-2/open-the-lock.md`（图论建模 BFS）或 `network-delay-time.md`（Dijkstra） |
