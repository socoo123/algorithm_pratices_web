...
> 最后更新：批 1 完成（磁盘 20 篇 / 20/300）

## 〇、当前指针（清空会话后只看这里）

| 项 | 值 |
|----|-----|
| **下一批** | **批 2** · 滑窗收尾 + 二分①：变长窗口 / 旋转数组 / 峰值 |
| 已完成 | 1/15 批（20/300） |
| 磁盘核对 | `ls solutions/lingcha-2/*.md \| wc -l` 应为 `20`；`20 ÷ 20 = 1` 已完成批 → 下一批 = 2 |
| 预查新题 | —（本批无 ≥3000 新题） |
| 样例 md | `solutions/lingcha-2/positions-of-large-groups.md`（分组循环）或 `k-radius-subarray-averages.md`（定长窗口） |
