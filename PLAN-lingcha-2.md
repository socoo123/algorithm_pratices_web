...
> 最后更新：批 11 完成（磁盘 220 篇 / 220/300）

## 〇、当前指针（清空会话后只看这里）

| 项 | 值 |
|----|-----|
| **下一批** | **批 12** · 数学收尾 + 字符串①：质数因子 + KMP/哈希 |
| 已完成 | 11/15 批（220/300） |
| 磁盘核对 | `ls solutions/lingcha-2/*.md \| wc -l` 应为 `220`；`220 ÷ 20 = 11` 已完成批 → 下一批 = 12 |
| 预查新题 | #3115, #3076 |
| 样例 md | `solutions/lingcha-2/three-divisors.md`（因子）或 `find-greatest-common-divisor-of-array.md`（GCD）；KMP/哈希尚无同族样例，可继续用数学篇看结构 |
